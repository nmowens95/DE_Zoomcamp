...
if not table_exists(client, table_id):
    ...
    load_job = client.load_table_from_uri(GCS_FILE_URI, table_id, job_config=job_config)
...
if not table_exists(client, table_id2):
    ...
    load_job2 = client.load_table_from_uri(GCS_FILE_URI2, table_id2, job_config=job_config)
